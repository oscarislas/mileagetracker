        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-ctp-subtext1 mb-3">
              ...
              <strong>{trip.client_name}</strong> on{" "}
  ...
  return (
    <>
      <div
        ...
        className="bg-ctp-surface0 rounded-lg border border-ctp-surface1 hover:border-ctp-surface2 transition-all duration-200 overflow-hidden group"
      >
        {/* Main content */}
        <div className="p-4">
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-ctp-text truncate">
                  {trip.client_name}
                </h3>
              </div>
            </div>
