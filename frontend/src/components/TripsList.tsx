...
export default function TripsList({
  ...
  const {
    ...
    isError,
    error,
  } = useTrips(currentPage, limit, filters);
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {connectionStatus && (
            <div className="flex items-center gap-1 text-xs">
              ...
              <span
                className={
                  connectionStatus.connected ? "text-ctp-green" : "text-ctp-red"
                }
              >
  ...
  return (
    <div
      ...
      className="bg-ctp-surface0 rounded-lg p-4 shadow-sm"
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <ListBulletIcon className="h-5 w-5 text-ctp-blue" />
              ...
              <div className="flex items-center gap-1">
                {[...Array(Math.min(5, total_pages))].map((_, i) => {
                  ...
                  if (
                    ...
                    return (
                      <span key={pageNum} className="text-ctp-subtext1">
                        ...
                      </span>
                    );
                  } else if (
