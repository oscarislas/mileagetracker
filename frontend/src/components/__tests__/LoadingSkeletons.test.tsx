...
describe("LoadingSkeletons", () => {
  describe("TripItemSkeleton", () => {
    it("renders skeleton for trip item", () => {
      ...
      expect(
        container.querySelectorAll(".bg-ctp-surface2").length,
      ).toBeGreaterThan(0);
    });
    ...
    it("has proper card structure", () => {
      ...
      expect(
        container.querySelector(".border-ctp-surface1"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("TripsEmptyState", () => {
    ...
    it("provides helpful getting started tips", () => {
      ...
      expect(
        screen.getByText(/Add trip date and miles driven/),
      ).toBeInTheDocument();
    });
  ...
  describe("Visual consistency", () => {
    it("all skeletons use consistent theme colors", () => {
      ...
      expect(
        tripContainer.querySelector('[class*="ctp-surface"]'),
      ).toBeInTheDocument();
      expect(
        summaryContainer.querySelector('[class*="ctp-surface"]'),
      ).toBeInTheDocument();
      expect(
        statsContainer.querySelector('[class*="ctp-"]'),
      ).toBeInTheDocument();
    });
    ...
    it("skeletons have proper loading animation", () => {
      ...
      expect(
        summaryContainer.querySelector(".animate-pulse"),
      ).toBeInTheDocument();
      expect(
        statsContainer.querySelector(".animate-pulse"),
      ).toBeInTheDocument();
    });
  });
});
