...
function TestModalHook() {
  ...
  return (
    <div>
      <button data-testid="open-button" onClick={openModal}>Open</button>
      <button data-testid="close-button" onClick={closeModal}>Close</button>
      <button data-testid="toggle-button" onClick={toggleModal}>Toggle</button>
...
describe('Modal Component', () => {
  ...
  describe('Size Variants', () => {
    ...
    it('applies full size classes', () => {
      ...
      const modal = screen.getByRole('dialog').querySelector('[tabindex="-1"]')
      expect(modal).toHaveClass('max-w-none', 'h-full', 'w-full', 'm-0', 'rounded-none')
    })
  })
  ...
  describe('Closing Behavior', () => {
    ...
    it('does not close when backdrop is clicked and closeOnOutsideClick is false', async () => {
      ...
      render(<TestModalComponent isOpen={true} onClose={mockOnClose} closeOnOutsideClick={false} />)
    ...
    it('does not close when ESC is pressed and closeOnEscape is false', async () => {
      ...
      render(<TestModalComponent isOpen={true} onClose={mockOnClose} closeOnEscape={false} />)
