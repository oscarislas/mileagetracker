...
describe("StatsCard", () => {
  ...
  it("applies correct color classes for blue theme", () => {
    const { container } = renderWithProviders(
      <StatsCard {...defaultProps} color="blue" />,
    );
  ...
  it("renders long titles and values without breaking layout", () => {
    const longTextProps = {
      ...
      value: "99,999,999.99",
      subtitle:
        "This is a very long subtitle that describes the statistic in detail",
    };
    ...
    expect(
      screen.getByText(
        "Very Long Statistics Title That Should Not Break Layout",
      ),
    ).toBeInTheDocument();
