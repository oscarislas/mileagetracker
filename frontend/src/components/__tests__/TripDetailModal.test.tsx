...
describe("TripDetailModal", () => {
  ...
  it("renders nothing when trip is null", () => {
    renderWithProviders(
      <TripDetailModal trip={null} isOpen={true} onClose={mockOnClose} />,
    );
  ...
  it("renders in view mode by default", () => {
    renderWithProviders(
      <TripDetailModal trip={mockTrip} isOpen={true} onClose={mockOnClose} />,
    );
  ...
  it("shows delete confirmation when delete button is clicked", () => {
    ...
    expect(
      screen.getByText(/This will permanently remove the trip to/),
    ).toBeInTheDocument();
    expect(screen.getByText("Test Client")).toBeInTheDocument();
    expect(screen.getByText("Delete Trip")).toBeInTheDocument();
