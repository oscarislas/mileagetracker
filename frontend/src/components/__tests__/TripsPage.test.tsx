...
describe("TripsPage", () => {
  beforeEach(() => {
    mockUseTrips.mockReturnValue({
      ...
      isPaused: false,
      isEnabled: true,
      promise: Promise.resolve(mockTripsData),
    ...
    mockUseSummary.mockReturnValue({
      ...
      isPaused: false,
      isEnabled: true,
      promise: Promise.resolve(mockSummaryData),
    ...
    mockUseAllClients.mockReturnValue({
      ...
      isPaused: false,
      isEnabled: true,
      promise: Promise.resolve(mockClientsData),
    ...
    mockUseClientSuggestions.mockReturnValue({
      ...
      isPaused: false,
      isEnabled: true,
      promise: Promise.resolve({ clients: [] }),
    } as UseQueryResult<ClientSuggestionsResponse>);
    ...
    mockUseCreateTrip.mockReturnValue({
      ...
      context: undefined,
      isPaused: false,
    } as UseMutationResult<Trip, Error, CreateTripRequest>);
  });
  ...
  test("populates client dropdown with fetched clients", () => {
    ...
    const testClientOption = screen.getByRole("option", {
      name: "Test Client",
    });
    const anotherClientOption = screen.getByRole("option", {
      name: "Another Client",
    });
  ...
  test("applies filters when Apply Filters button is clicked", async () => {
    ...
    await waitFor(() => {
      ...
      const lastCall =
        mockUseTrips.mock.calls[mockUseTrips.mock.calls.length - 1];
  ...
  test("displays total trips count from trips data, not summary data", () => {
    ...
    mockUseTrips.mockReturnValue({
      ...
      isPaused: false,
      isEnabled: true,
      promise: Promise.resolve(mockTripsDataWithTotal),
    } as UseQueryResult<TripsResponse>);
    ...
    mockUseSummary.mockReturnValue({
      ...
      isPaused: false,
      isEnabled: true,
      promise: Promise.resolve(mockSummaryWithoutTotal),
    } as UseQueryResult<SummaryResponse>);
  ...
  test("displays 0 total trips when trips data is not loaded", () => {
    mockUseTrips.mockReturnValue({
      ...
      isPaused: false,
      isEnabled: true,
      promise: Promise.resolve(undefined as unknown as TripsResponse),
    } as UseQueryResult<TripsResponse>);
