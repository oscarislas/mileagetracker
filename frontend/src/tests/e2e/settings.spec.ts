...
test.describe("Settings Management", () => {
  test("should show proper error state when backend is unavailable", async ({
    page,
  }) => {
    ...
    await expect(
      page.getByText("Failed to connect to the server"),
    ).toBeVisible();
  ...
  test("should display the settings page", async ({ page }) => {
    ...
    await expect(
      page.getByText("Configure your mileage tracking preferences"),
    ).toBeVisible();
  });
  ...
  test("should validate mileage rate input", async ({ page }) => {
    ...
    // Should show error
    await expect(
      page.getByText("Please enter a valid mileage rate"),
    ).toBeVisible();
